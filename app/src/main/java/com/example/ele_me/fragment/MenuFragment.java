...
public class MenuFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentView = inflater.inflate(R.layout.slidingpane_menu_layout,
                container, false);
        bt_abouts = currentView.findViewById(R.id.btn_abouts);
        bt_gift = currentView.findViewById(R.id.btn_gift);
        bt_home = currentView.findViewById(R.id.btn_home);
        bt_invitation = currentView.findViewById(R.id.btn_invitation);
        iv_login = currentView.findViewById(R.id.iv_login);
        bt_camera = currentView.findViewById(R.id.btn_camera);
        initRoundImage();
        bt_orders = currentView.findViewById(R.id.btn_order);
