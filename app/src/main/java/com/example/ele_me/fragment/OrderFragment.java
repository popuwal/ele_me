...
public class OrderFragment extends Fragment implements OnClickListener {
    ...
    private void initView() {
        // TODO Auto-generated method stub
        errorNoOrder = currentView.findViewById(R.id.order_error_no_history_order);
        orderTimeLine = currentView.findViewById(R.id.timeline);
        timeLineListView = currentView.findViewById(R.id.timeline_list);
        ...
        switch (v.getId()) {
            case (R.id.linear_above_toHome):
                openMenu.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                        final SlidingPaneLayout slidingPaneLayout = getActivity().findViewById(R.id.slidingpanellayout);
