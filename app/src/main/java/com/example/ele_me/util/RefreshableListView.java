...
//    private static final String TAG = RefreshableListView.class.getSimpleName();
    ...
    private void initialize() {
        ...
        mArrow = mHeaderContainer.findViewById(R.id.refreshable_list_arrow);
        mProgress = mHeaderContainer.findViewById(R.id.refreshable_list_progress);
        mText = mHeaderContainer.findViewById(R.id.refreshable_list_text);
    ...
    public interface OnRefreshListener {
        void onRefresh(RefreshableListView listView);
    }
